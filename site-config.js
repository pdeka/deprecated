...
if (_.isEmpty(argv.theme) || _.includes(["mosman", "narrabeen", "randwick"], argv.theme) === false || _.isEmpty(argv.theme-version)) {
...
prodConfiguration(apiEndpoint, argv.theme, 8000, argv.theme-version);
